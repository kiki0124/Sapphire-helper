...
class epi(commands.Cog):
    ...
    @app_commands.command(name="lock", description="Lock the given channels. Select channels by sending the command. Should only be used in emergencies.")
    @app_commands.checks.has_any_role(EXPERTS_ROLE_ID, MODERATORS_ROLE_ID, DEVELOPERS_ROLE_ID)
    ...
    @app_commands.command(name="unlock", description="Unlock the given channels. Select channels by sending the command.. Should only be used in emergencies.")
    @app_commands.checks.has_any_role(MODERATORS_ROLE_ID, EXPERTS_ROLE_ID, DEVELOPERS_ROLE_ID)
    ...
    @app_commands.command(name="slowmode", description="Set a specified slowmode time for the given channels. Select channels by sending the command. Should only be used in emergencies.")
