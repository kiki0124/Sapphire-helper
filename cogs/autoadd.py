...
class ConfirmCloseButtons(ui.ActionRow):
    ...
    @ui.button(label="Mark as solved", style=discord.ButtonStyle.gray, custom_id="auto-close-confirm")
...
class autoadd(commands.Cog):
    ...
    async def on_thread_create(self, thread: discord.Thread):
        ...
        if (
            ...
            and not thread.owner.bot # prevent the message from sending if it was created via rtdr
        ):
            view = ui.LayoutView()
